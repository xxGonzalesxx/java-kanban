...
class SubtaskTest {
    ...
    void constructorShouldSetAllFields() {
        Subtask subtask = new Subtask(1, "tasks.Subtask", "Описание", Status.NEW, 100);

        assertEquals(1, subtask.getId());
        assertEquals("tasks.Subtask", subtask.getName());
    ...
    void getEpicId_shouldReturnCorrectEpicId() {
        ...
        assertEquals(200, subtask.getEpicId(), "tasks.Subtask должен хранить правильный epicId");
    }
    ...
    void subtaskEquals_shouldReturnTrueForSameId() {
        ...
        assertEquals(s1, s2, "tasks.Subtask с одинаковым id должны считаться равными");
    ...
    void subtaskEquals_shouldReturnFalseForDifferentId() {
        ...
        assertNotEquals(s1, s2, "tasks.Subtask с разными id не должны быть равны");
    }
}
